      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6 space-y-3">
          ...
          <FilterBar>
            ...
            <FilterSelect value={verifiedFilter} onChange={(v) => { setVerifiedFilter(v); setCurrentPage(1); }} ariaLabel="Validation">
                <option value="all">Tous</option>
                <option value="verified">Validés</option>
                <option value="pending">En attente</option>
            </FilterSelect>
            <FilterResetButton onClick={() => { setSearch(''); setStatusFilter('all'); setVerifiedFilter('all'); setCurrentPage(1); }} />
          </FilterBar>
        </div>
