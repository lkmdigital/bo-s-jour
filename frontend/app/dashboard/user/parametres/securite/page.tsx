...
import {
  Lock, ShieldCheck, KeyRound, Copy, Eye, EyeOff, Loader2, CheckCircle2, ArrowRight,
} from 'lucide-react';
...
export default function MemberSecuritySettingsPage() {
  ...
  useEffect(() => {
    if (!isLoading && !isAuthenticated) router.push('/auth/login?redirect=/dashboard/user/parametres/securite');
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      <div className="xl:col-span-2 space-y-6 max-w-2xl">
        <MemberSettingsPageHeader
          icon={ShieldCheck}
          title="Sécurité"
          description="Mot de passe et double authentification pour votre compte."
        />
