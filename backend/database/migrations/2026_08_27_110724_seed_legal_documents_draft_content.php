...
Les présentes Conditions Générales d'Utilisation (« CGU ») ont pour objet de définir les modalités et conditions dans lesquelles BoSéjour met à disposition sa plateforme de réservation d'hébergements (la « Plateforme »), accessible notamment via le site bosejour.ci, ainsi que les droits et obligations des utilisateurs dans ce cadre.
...
« Plateforme » désigne le site et les applications BoSéjour permettant la mise en relation entre Voyageurs et Partenaires.
...
Un Partenaire souhaitant proposer un hébergement doit fournir les documents justificatifs demandés par BoSéjour (pièce d'identité, justificatifs relatifs à l'établissement) dans le cadre du contrôle de conformité préalable à la publication de son annonce. BoSéjour se réserve le droit de refuser, suspendre ou retirer la publication d'un établissement dont la conformité documentaire n'est pas ou plus assurée.
...
La Plateforme distingue plusieurs profils : Voyageur, Partenaire, Compte Entreprise et Administrateur. Les fonctionnalités accessibles diffèrent selon le profil. BoSéjour se réserve le droit de faire évoluer les fonctionnalités propres à chaque profil sans que cela ne constitue une modification substantielle des présentes CGU.
...
La Plateforme propose, pour certains profils (Administrateur, Partenaire, Voyageur), un assistant conversationnel s'appuyant sur un service d'intelligence artificielle tiers (Claude, développé par Anthropic). Cet assistant fournit des réponses, recommandations ou brouillons de contenu à partir des données de la Plateforme ; il ne prend aucune décision automatique engageant BoSéjour ou l'Utilisateur, et ses suggestions doivent être vérifiées avant d'être suivies. Le traitement des données par ce prestataire est décrit dans la Politique de Confidentialité.

Article 7 — Programme Membre et Programme Corporate

BoSéjour propose un programme de fidélité (points, niveaux, bons de réduction) et un programme dédié aux Comptes Entreprise. Les règles de fonctionnement de ces programmes, ainsi que les conditions d'obtention et d'utilisation des avantages associés, sont précisées dans les Conditions Générales de Vente et dans les pages dédiées de la Plateforme. BoSéjour se réserve le droit de modifier ou de mettre fin à ces programmes, sous réserve d'en informer les Utilisateurs concernés.

Article 8 — Propriété intellectuelle

La Plateforme, sa structure, ses éléments graphiques, sa marque et ses contenus éditoriaux sont la propriété de BoSéjour ou de ses partenaires, et sont protégés par le droit de la propriété intellectuelle. Toute reproduction ou exploitation non autorisée est interdite.

Les Partenaires demeurent titulaires des droits sur les contenus (textes, photographies) qu'ils publient, et en garantissent la licéité. Ils concèdent à BoSéjour le droit de les afficher et de les diffuser dans le cadre du fonctionnement de la Plateforme.

Article 9 — Responsabilité

BoSéjour agit en qualité d'intermédiaire technique entre Voyageurs et Partenaires. Les hébergements proposés sont sous la seule responsabilité des Partenaires qui les publient : BoSéjour ne garantit ni la qualité, ni la conformité, ni la disponibilité réelle des hébergements présentés, au-delà des contrôles de conformité qu'elle met en œuvre.

BoSéjour ne saurait être tenue responsable des dommages résultant d'une interruption, d'un dysfonctionnement de la Plateforme, ou d'un manquement d'un Partenaire ou d'un Voyageur à ses obligations.

Article 10 — Suspension et résiliation

BoSéjour peut suspendre ou résilier l'accès d'un Utilisateur à la Plateforme en cas de manquement aux présentes CGU, de fraude avérée ou suspectée, ou de non-respect de la réglementation applicable, après notification lorsque les circonstances le permettent.
...
BoSéjour peut modifier les présentes CGU à tout moment. Les Utilisateurs sont informés de toute modification substantielle ; la poursuite de l'utilisation de la Plateforme après notification vaut acceptation des CGU modifiées.
EOT,
            'cgv' => <<<'EOT'
Article 1 — Objet

Les présentes Conditions Générales de Vente (« CGV ») régissent les modalités de réservation et de paiement des hébergements proposés par les Partenaires sur la Plateforme BoSéjour. Elles complètent les Conditions Générales d'Utilisation.
...
Les prix sont exprimés en francs CFA (FCFA), toutes taxes applicables comprises sauf mention contraire. Le paiement s'effectue en ligne, au moment de la réservation, via les moyens de paiement proposés par la Plateforme (notamment Wave, Orange Money, carte bancaire Visa/Mastercard, Djamo), par l'intermédiaire d'un prestataire de paiement tiers. BoSéjour ne conserve pas les données de carte bancaire du Voyageur ; celles-ci sont traitées directement par le prestataire de paiement.
...
Lorsque l'annulation intervient dans les délais prévus par cette politique, ou lorsque la réservation est refusée par le Partenaire, le montant remboursable est déterminé selon les règles applicables à la réservation concernée. Le remboursement est ensuite traité par les équipes BoSéjour vers le moyen de paiement utilisé lors de la réservation, dans un délai indicatif qui sera précisé au Voyageur lors du traitement de sa demande. BoSéjour ne garantit pas un remboursement automatique instantané.

Toute demande relative à une annulation ou à un remboursement peut être adressée au service client BoSéjour.
...
À l'issue de son séjour, le Voyageur peut publier un avis et une note sur l'hébergement. Les avis doivent refléter une expérience réelle et respecter les règles de modération de la Plateforme ; BoSéjour se réserve le droit de retirer un avis manifestement mensonger, injurieux ou sans lien avec un séjour réel.
...
Toute réclamation relative à une Réservation peut être adressée au service client BoSéjour par les canaux indiqués sur la Plateforme. BoSéjour s'efforce d'apporter une réponse dans un délai raisonnable ; elle peut, le cas échéant, faciliter la mise en relation entre le Voyageur et le Partenaire concerné.
...
Le responsable du traitement des données à caractère personnel collectées sur la Plateforme BoSéjour est la société éditrice de BoSéjour (« BoSéjour »). Les coordonnées de contact figurent à l'Article 11 ci-dessous.

Article 2 — Données collectées

Selon son profil et son usage de la Plateforme, BoSéjour peut collecter :
...
— des données de paiement limitées : BoSéjour ne stocke pas les données de carte bancaire, celles-ci étant traitées directement par le prestataire de paiement (voir Article 5) ;
...
Selon la finalité concernée, certaines données sont transmises à des prestataires intervenant pour le compte de BoSéjour : le prestataire de paiement (Malia Pay) pour le traitement des transactions ; les prestataires de messagerie et de notification (dont WhatsApp Business/Meta, un service de notifications push, un service d'envoi de SMS) pour l'envoi de communications ; le prestataire d'intelligence artificielle (Anthropic) pour les fonctionnalités décrites à l'Article 4. Ces prestataires ne sont autorisés à traiter les données que pour les finalités convenues avec BoSéjour.

BoSéjour ne vend ni ne loue les données personnelles des Utilisateurs à des tiers à des fins commerciales.
...
BoSéjour met en œuvre des mesures techniques et organisationnelles raisonnables pour protéger les données personnelles contre la perte, l'accès non autorisé, la divulgation ou l'altération.

Article 8 — Droits des personnes

Conformément à la loi ivoirienne n° 2013-450 du 19 juin 2013 relative à la protection des données à caractère personnel, tout Utilisateur dispose d'un droit d'accès, de rectification, d'opposition et de suppression de ses données personnelles. Ces droits peuvent être exercés auprès de BoSéjour selon les modalités indiquées à l'Article 11. L'Utilisateur dispose également du droit d'introduire une réclamation auprès de l'Autorité de Régulation des Télécommunications/TIC de Côte d'Ivoire (ARTCI), autorité compétente en matière de protection des données personnelles.
...
Certains prestataires mentionnés à l'Article 5, dont le prestataire d'intelligence artificielle, sont établis hors de Côte d'Ivoire, notamment aux États-Unis. BoSéjour veille à ce que ces transferts s'accompagnent de garanties appropriées conformes à la réglementation applicable.

Article 11 — Contact

Pour toute question relative à la présente politique ou pour exercer ses droits, l'Utilisateur peut contacter BoSéjour via les coordonnées de contact indiquées sur la Plateforme.

Article 12 — Modification de la politique

La présente politique peut être modifiée pour refléter l'évolution des traitements réalisés par BoSéjour ou de la réglementation applicable. La version en vigueur est celle publiée sur la Plateforme, avec sa date de mise à jour.
EOT,
        ];
