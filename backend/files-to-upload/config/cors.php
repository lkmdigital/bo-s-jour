...
return [
    ...
    'allowed_origins' => array_filter(explode(',', env('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://localhost:3001,http://72.62.16.236,http://72.62.31.145,http://bosejour.ci,https://bosejour.ci,https://monbeaupays.com,https://www.monbeaupays.com'))),
