...
<head>
  ...
  <title>Confirmez les informations de votre établissement</title>
</head>
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 16px;font-size:15px;color:#374151;line-height:1.6;">
                Les informations de votre établissement <strong>{{ $accommodationName }}</strong>
                n'ont pas été confirmées depuis plusieurs mois. Pour que les voyageurs voient
                toujours des données exactes, merci de vérifier :
              </p>

              <div style="margin:0 0 24px;font-size:14px;color:#374151;line-height:1.8;background:#f9fafb;border-radius:8px;padding:16px 20px;">
                <ul style="margin:0;padding-left:18px;">
                  <li>les tarifs et disponibilités,</li>
                  <li>les photos de l'établissement,</li>
                  <li>les équipements et services proposés,</li>
                  <li>vos coordonnées de contact.</li>
                </ul>
              </div>

              <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.6;">
                Si tout est déjà à jour, vous pouvez simplement le confirmer en un clic depuis
                votre Extranet — aucune modification n'est nécessaire.
              </p>
              ...
              <p style="margin:0;font-size:13px;color:#9ca3af;line-height:1.6;">
                Une question&nbsp;? Contactez notre équipe support.
              </p>
            </td>
          </tr>
          <tr>
