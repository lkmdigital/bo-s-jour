        ...
        <table width="580" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
          <tr>
            <td style="background:#000000;padding:32px 40px;text-align:center;">
              ...
              <p style="margin:6px 0 0;color:rgba(255,255,255,0.75);font-size:13px;">Votre séjour commence ici…</p>
            </td>
          </tr>
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              @if ($stage >= 3)
                <p style="margin:0 0 28px;font-size:15px;color:#374151;line-height:1.6;">
                  C’est notre dernier rappel : votre réservation est bien enregistrée, mais votre espace
                  personnel n’est pas encore activé. En créant votre mot de passe, vous retrouverez
                  <strong>toutes vos réservations</strong>, vos <strong>avoirs</strong> et vos <strong>favoris</strong> au même endroit.
                </p>
              @elseif ($stage == 2)
                <p style="margin:0 0 28px;font-size:15px;color:#374151;line-height:1.6;">
              ...
              <p style="margin:0;font-size:13px;color:#9ca3af;line-height:1.6;">
                Vous n’êtes pas à l’origine de cette réservation&nbsp;? Vous pouvez ignorer cet e-mail.
              </p>
            </td>
          </tr>
          <tr>
