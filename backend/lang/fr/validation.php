...
// Traduction française des messages de validation Laravel — le projet ne livrait aucun
// fichier de langue (ni en, ni fr), donc les erreurs de validation renvoyées par l'API
// (ex. "The check in field must be a date after today.") s'affichaient toujours en
// anglais brut côté frontend, même si le front est entièrement en français.
// Structure standard Laravel (mêmes clés que le fichier officiel laravel-lang/fr).
...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | Champs les plus visibles côté formulaires voyageur/hôte, pour des messages
    | naturels ("La date d'arrivée doit être postérieure à..." plutôt que
    | "Le champ check in doit être...").
    */
    'attributes' => [
        ...
        'company_billing_email' => 'e-mail de facturation',
        'city' => 'ville',
        'address' => 'adresse',
        'amount' => 'montant',
